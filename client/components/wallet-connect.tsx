      ...
      {!address ? (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent className="w-50">
            <DropdownMenuLabel className="text-center">Wallet Details</DropdownMenuLabel>
            <DropdownMenuSeparator />
              ...
              <DropdownMenuItem asChild>
                <div className="flex items-center justify-start w-full">
                  <a
                    ...
                    className="truncate"
                  >
                    Address: {formatShortAddress(address)}
                  </a>
                  <Button
                    size="icon"
                    variant="ghost"
            ...
            {balance && (
              <DropdownMenuItem disabled className="data-[disabled]:opacity-1">
                Balance: {balance} ETH
              </DropdownMenuItem>
            )}
              ...
              <DropdownMenuItem asChild>
                <div className="flex items-center justify-start w-full">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    onClick={() =>
                      handleCopy(contractAddress, "Contract Address")
                    }
                  >
                    <Copy className="h-4 w-4" />
                  </Button>
